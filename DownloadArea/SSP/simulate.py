...
if __name__ == '__main__':
    ...
    result = simulate_ssp(args.ssp_filename, stop_time=args.stop_time, step_size=0.01)
    ...
    if args.show_plot:
        ...
        #print('[DEBUG] names to plot: ', names)
        plot_result(result=result, names=['Raspberry.GPIO 1', 'Raspberry.GPIO 2', 'Raspberry.GPIO 3'], window_title=args.ssp_filename)
